  ...
  return (
    <section id="about" className="relative scroll-mt-24 border-t border-white/5 py-20 sm:py-28">
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <h2 className="mt-3 max-w-2xl font-display text-4xl tracking-wide text-white sm:text-5xl">
        ...
        <div className="mt-14 grid gap-10 md:grid-cols-3">
          ...
          <article>
            ...
            <h3 className="mt-3 text-lg font-semibold text-white">Beat the clock</h3>
            <p className="mt-2 text-sm leading-relaxed text-slate-400">
          ...
          <article>
            ...
            <h3 className="mt-3 text-lg font-semibold text-white">Challenge friends</h3>
            <p className="mt-2 text-sm leading-relaxed text-slate-400">
